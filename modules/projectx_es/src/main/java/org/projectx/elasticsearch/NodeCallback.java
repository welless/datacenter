 ...
 * @param <T>
 *            the {@link ActionResponse} sub-class returned by the node
 *            operation
 */
public interface NodeCallback<T extends ActionResponse> {
	
	/**
	 * Execute an action using the provided {@link IndicesAdminClient} given on
	 * a configured client
	 * 
	 * @param client
	 *            an instance of {@link IndicesAdminClient}
	 * @return an {@link ActionFuture} with the appropriate
	 *         {@link ActionResponse} subclass
	 */

...
@ContextConfiguration(locations = { "classpath:org/projectx/elasticsearch/applicationContext-elasticsearch-test.xml" })
public class ElasticSearchNodeTempIntegrationTest extends ElasticsearchNodeTempTestBase {

	@Test
	public void index() throws Exception {

		final Collection<File> files = Collections.singletonList(new File("src/test/resources/othello1-1.txt"));
